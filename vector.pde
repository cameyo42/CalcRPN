...
void fnVECADD()
{
  ...
  else { outputSTR = "Vec3D addition: six numbers required."; }
  functionType = 0;
}
...
void fnVECSUB()
{
  ...
  else { outputSTR = "Vec3D subtraction: six numbers required."; }
  functionType = 0;
}
...
void fnVECCRO()
{
  ...
  else { outputSTR = "Vec3D cross product: six numbers required."; }
  functionType = 0;
}
...
void fnVECDOT()
{
  ...
  else { outputSTR = "Vec3D dot product: six numbers required."; }
  functionType = 0;
}
...
void fnVECANG()
{
  ...
  else { outputSTR = "Vec3D angle between: six numbers required."; }
  functionType = 0;
}
...
void fnVECMAG()
{
  ...
  else { outputSTR = "Vec3D Mag&Heading: three numbers required."; }
  functionType = 0;
}
