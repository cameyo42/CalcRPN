...
void fnRDOWNS()
{
  ...
  else { outputSTR = "Roll Down: at least two numbers required."; }
}
...
void fnRUPS()
{
  ...
  else { outputSTR = "Roll Up: at least two numbers required."; }
}
